        ...
        <Herosection  title={"Register Page"}/>
            ...
            <div className="w-full px-3  md:px-20 flex flex-col md:flex-row py-8 border-0 md:mb-32">
                <div className="md:w-1/2">
                    ...
                    <img src="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fthumb%2F14.jpg&w=1920&q=75" className="rounded-t-lg md:rounded-l-xl md:rounded-t-none shadow-xl/40 "/>
                </div>
               <div className="bg-white md:w-1/2 pb-4 px-2 pt-4 md:pt-15 text-center md:text-start md:pl-24 flex flex-col gap-5 rounded-b-lg md:rounded-r-xl shadow-xl/30 dark:bg-neutral-700/60 md:rounded-bl-none">
                        ...
                        <button className="bg-green-700 h-10 md:w-120  p-2 border-0 rounded-lg w-full text-white">REGISTER</button>
                         ...
                         <div className="text-center font-[Marcellus]">
                            <span className="text-gray-400"> Already have an account?</span> <span className="text-red-600"><u onClick={()=>router.push('/Login')}>Login Now</u></span>
                        </div>
                </div>
