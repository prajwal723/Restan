  ...
  return (
    <>
      ...
      <div className="bg-gray-200 dark:bg-neutral-900 pt-8 pb-20 overflow-x-hidden md:pt-24 md:pb-40 ">
        <h2 className="text-[#826a45] font-serif text-xl text-center font-medium md:text-2xl md:mb-3 dark:text-[#daa85d]">
          CATEGORY
        </h2>
        <h1 className="font-bold text-4xl text-black text-center md:text-6xl dark:text-white">
        ...
        <div className="md:grid md:grid-cols-4 md:mx-14 ">
          ...
          />
          <FoodMenu
            image="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fthumb%2F17.jpg&w=1920&q=75"
            title="Salmon Steak"
            ratings="4.9"
          />
          <FoodMenu
            image="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fthumb%2F18.jpg&w=1920&q=75"
            title="Fries McDonald's"
            ratings="4.7"
          />
          <FoodMenu
            image="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fthumb%2F19.jpg&w=1920&q=75"
            title="Chocolate chip"
            ratings="4.9"
          />
          <FoodMenu
            image="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fthumb%2F20.jpg&w=1920&q=75"
        ...
        <div className="px-3  py-10 bg-black/85 w-full mt-20 text-white md:px-20 md:py-24 md:flex md:flex-row relative ">
          <div className="space-y-7">
            <h1 className="text-5xl  font-medium md:text-8xl md:w-1/2">
              30 Minutes Delivery!
            </h1>
            <p className="text-[15px] text-gray-300  my-2.5 md:w-1/2 md:text-lg">
            ...
            <button
              className="bg-[#826a45] p-4 mt-6 text-white px-8 rounded-4xl hover:bg-black md:text-2xl"
          ...
          <img
            ...
            alt="delivery boy"
            className="hidden md:block md:w-1/3 absolute right-10 top-20 z-1"
          />
        </div>
