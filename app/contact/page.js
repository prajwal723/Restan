...
export default function Contact(){
    return<>
       ...
       <div className="bg-gray-200 py-10 md:py-16  ">
             ...
             <div className="bg-white py-10 mt-14  px-8 m-2 rounded-xl space-y-3 shadow-2xl shadow-gray-300 md:mx-20 md:px-24 md:py-10">
                <h2 className="text-[#826a45] text-xl font-semibold text-center">Keep in touch</h2>
                <h1 className="text-black font-bold text-4xl text-center">Send us a Massage</h1>
                <form className="text-black space-y-4">
                    <input type="text" placeholder="Name" className="p-3 w-full bg-gray-200 rounded"/>
                    <div className="space-y-4 md:space-y-0 md:flex md:gap-3">
                        <input type="email" placeholder="Email*" className="p-3 w-full bg-gray-200 rounded"/>
                        <input type="tel" placeholder="Phone" className="p-3 w-full bg-gray-200 rounded"/>
                    </div>
                    <input type="text" placeholder="Your Message" className="p-3 w-full bg-gray-200 rounded pb-24 items-start "/>
             ...
             <div className="relative px-3 md:px-20 md:pt-10 md:pb-28">
                <div className="text-gray-300 text-9xl font-bold font-serif opacity-50 hidden md:block">RESTAN</div>
                ...
                <div className="bg-white shadow-2xl shadow-gray-300 md:w-3xl  space-y-6 px-5 py-9 md:px-17 md:py-24 md:absolute md:top-0 md:right-20">
                    <h1 className="text-black font-semibold text-3xl">Opening Hours</h1>
                    <p className="text-neutral-500 text-sm">A relaxing and pleasant atmosphere, good jazz, dinner, and cocktails. The Patio Time Bar opens in the center.</p>
                    <div className="text-neutral-900 font-semibold space-y-3 md:space-y-2">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-1.5">
                            <p className="text-neutral-500">Call Anytime</p>
                            <p className="text-xl font-semibold text-neutral-900">+964733-378901</p>
                        </div>
                    </div>
                </div>
             </div>
...
function Contactcontainer({img,title,contactdet,location}){
    return<>
        <div className="space-y-3 items-center justify-items-center bg-white p-8 rounded-xl border-neutral-300 border md:w-90  ">
            <img src={img} alt={contactdet} className="h-15"/>
            <h1 className="font-semibold text-2xl text-black">{title}</h1>
            <h2 className="font-semibold text-md text-black">{contactdet}</h2>
            <h3 className="text-neutral-500 text-center">{location}</h3>
        </div>
    </>
}