      ...
      <ul className="flex justify-between text-black text-lg font-semibold  items-center md:justify-start  md:mr-20">
        ...
        <li>
          <img
            ...
            alt="Logo"
            className="h-16 md:mr-96 md:h-24 "
          />
        </li>
        <ul className="md:flex md:gap-14 flex-row hidden text-center">
          ...
          <select
            ...
            className="bg-white border-0 text-black font-semibold cursor-pointer"
          >
            <option>Pages</option>
        ...
        <li>
          <img
            src="https://img.icons8.com/?size=100&id=59997&format=png&color=1A1A1A"
            alt="cart"
            className="h-12 md:ml-80"
  ...
  return (
    <>
      <div
        ...
        } fixed top-0 left-0 w-5/6 h-full text-black bg-white shadow-md z-50`}
      >
