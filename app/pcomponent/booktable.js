        ...
        <div className="bg-zinc-900 absolute mr-3  p-3 py-12 border border-gray-600 rounded-3xl md:right-20  md:py-20 md:top-20 md:px-10 md:w-1/3">
          ...
          >
            <input
              ...
              maxLength={10}
              required
              className="border bg-gray-600 border-gray-300 p-2 rounded-md w-full md:p-3"
            />
            ...
            <input
              ...
              placeholder="Date"
              required
              className="border bg-gray-600 border-gray-300 p-2 text-white rounded-md w-full md:p-3"
            />
            <input
              type="time"
              placeholder="Time"
