 export default function CustomerReview() {
    return<>
        ...
        <img src="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fshape%2F5.png&w=1920&q=75" className="h-32 top-16 absolute dark:invert opacity-35 hidden md:block"/>
                 <div className="flex  justify-center md:gap-3 items-center">
                    <img src="	https://restan-nextjs.vercel.app/_next/static/media/17-2.f96247ed.png" alt="line" className="hidden md:block h-4"/>
                    <h2 className="text-red-500 font-serif text-xl md:text-2xl text-center font-medium ">HAPPY CUSTOMERS</h2>
                    <img src="https://restan-nextjs.vercel.app/_next/static/media/18-2.1e981c0c.png" alt="line" className="hidden md:block h-4"/>
                 </div>
                ...
                <div className="md:flex md:flex-row md:justify-between md:mx-20">
                    ...
                    <div className="md:w-1/2 md:mt-10 space-y-6">
                       ...
                       <img src="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fshape%2F7.png&w=1920&q=75"  className="h-28 bottom-10 right-2 absolute dark:invert opacity-35 hidden md:block"/>
                    </div>
                </div>
            </div>
    </>
