      ...
      <div className="space-y-3 p-5">
        <div className=" flex flex-col text-sm md:text-lg space-y-1">
          <div className="flex flex-row">
            <img
              src="https://img.icons8.com/?size=100&id=89550&format=png&color=1A1A1A"
              alt="calendar"
              className="h-4  mr-2 md:h-6 dark:invert"
            />
            12 August,2024
          </div>
          <div className="flex flex-row">
        ...
        <div className="text-black font-semibold text-3xl md:text-4xl dark:text-white">
          {title}
        </div>
        ...
        <button className="bg-[#826a45] p-3 text-white px-7 rounded-4xl hover:bg-black md:text-2xl dark:hover:bg-white dark:hover:text-black">
          Read More
        </button>
      </div>
    </div>
