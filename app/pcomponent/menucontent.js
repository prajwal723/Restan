    ...
    return <>
        <div className="bg-white mx-3 pb-8 mt-8 shadow-md rounded-xl space-y-3">
            ...
            <div className=" flex flex-row gap-16 my-7 items-center">
                <button className="border-l-[#75562d] border-2 relative text-gray-200  bg-gray-200 px-16 py-7 rounded-r-4xl">
            ...
            <h2 className="text-black font-semibold text-2xl px-7 hover:text-[#75562d]">{title}</h2>
            <p className=" text-gray-800 px-7">Cheese, Ham & Pineapple</p>
            <button className="bg-[#75562d] p-3 mx-7 text-white px-7 rounded-4xl hover:bg-black">ORDER NOW</button>
        </div>
    </>
}