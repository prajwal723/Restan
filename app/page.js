        ...
        <div className="mt-8 m-3 md:flex md:flex-row md:justify-around">
            ...
            <div className="space-y-4 md:mt-24 md:w-6xl md:ml-16 md:space-y-7">
                <div className="flex gap-3 items-center">
                    ...
                    <img src="https://restan-nextjs.vercel.app/_next/static/media/18-2.1e981c0c.png" className="h-3"/> 
                </div>
    ...
    <div className="py-16 relative">
        <div className="md:flex  bg-stone-200 dark:bg-neutral-800 ">
            <div className="bg-black  py-12 p-3 justify-start space-y-3 md:py-28 md:p-14 md:space-y-5  md:px-20">
                <img src="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fillustration%2F2.png&w=1080&q=75" alt="plate" className="absolute h-44 top-0 left-0 hidden md:block"/>
               <div className="flex items-center gap-3">
                ...
                <button className={`p-4 w-full border text-white justify-between flex border-gray-300 rounded-lg ${dishes==1?'bg-red-700':'null'} md:text-xl`} onClick={()=>{setdishes(1)}}>MAIN DISHES
                ...
                <button className={`p-4 w-full border text-white justify-between flex border-gray-300 rounded-lg ${dishes==2?'bg-red-700':'null'} md:text-xl`} onClick={()=>{setdishes(2)}}>DESSERTS
                ...
                <button className={`p-4 w-full border text-white justify-between flex border-gray-300 rounded-lg ${dishes==3?'bg-red-700':'null'} md:text-xl`} onClick={()=>{setdishes(3)}}>SEA FOOD
                ...
                <button className={`p-4 w-full border text-white justify-between flex border-gray-300 rounded-lg ${dishes==4?'bg-red-700':'null'} md:text-xl`} onClick={()=>{setdishes(4)}}>BEVERAGE
        ...
        <div className="justify-items-center-safe   m-3 space-y-7">
            ...
            <div className="md:flex space-y-7 md:gap-7 p-1 md:p-10">
                <div className="space-y-7 md:w-100">
                    <Foodgallery img="https://restan-nextjs.vercel.app/assets/img/portfolio/1.jpg" title="MINION DRINKS" desc="Cold Lemmon Juice"/>
                    {/* <img src="https://restan-nextjs.vercel.app/assets/img/portfolio/1.jpg" alt="item" className="md:w-92.5" /> */}
                </div>
                <div className="space-y-7 md:w-100 ">
                    <Foodgallery img="https://restan-nextjs.vercel.app/assets/img/portfolio/2.jpg" title="GRILL CHICKEN" desc="Chicken Sandwich"/>
                    <Foodgallery img="https://restan-nextjs.vercel.app/assets/img/portfolio/6.jpg" title="CHEESY FAVORITE" desc="Crispy Crust Pizzeria"/>
                ...
                <div className="space-y-7 md:w-100 ">
                    <Foodgallery img="https://restan-nextjs.vercel.app/assets/img/portfolio/3.jpg" title="CHEESY FAVORITE" desc="Salmon Steak"/>
                    <Foodgallery img="https://restan-nextjs.vercel.app/assets/img/portfolio/5.jpg" title="GRILL CHICKEN" desc="Chicken Sandwich"/>
