...
export default function ShopPage() {
    ...
    <div className="bg-gray-200">
        ...
        <div className="md:mb-40 flex justify-center space-x-3 "> 
            <button className="bg-stone-400 px-3.5 py-2 rounded-lg border border-gray-500 hover:bg-stone-500 hover:scale-105">1</button>
            <button className="bg-stone-400 px-3.5 py-2 rounded-lg border border-gray-500 hover:bg-stone-500 hover:scale-105">2</button>
            <button className="bg-stone-400 px-3.5 py-2 rounded-lg border border-gray-500 hover:bg-stone-500 hover:scale-105">3</button>
        </div>
        <Footer/>
    </div>
    </>
...
function Shopcontent({img,desc,title,price}){
    ...
    return <>
    <div className="bg-white mx-3 mt-5 py-10 rounded-xl justify-items-center-safe  space-y-3 hover:scale-105 group">
        ...
        <div className="text-center space-y-1.5 ">
            ...
            <button className="border-2 border-[#826a45] group-hover:bg-[#826a45] group-hover:text-white rounded-3xl text-black/75 px-7 py-3 font-semibold text-[14px]" onClick={()=>Onset()}>ADD TO CART</button>
        </div>
    </div>
    </>
}